...
@section('content')
    <div class="row gx-5">
        <div class="col overflow-hidden" style="margin-left: 98px;">
            ...
            <button style="margin-top: 80px; font-size: 16px;`" class="btn btn-primary" style="urbanist-semibold">Mulai Sekarang</button>
        </div>
        <div class="col-sm-6">
