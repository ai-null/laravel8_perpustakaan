<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="padding: 5px 80px 5px 100px">
    <a class="navbar-brand" href="{{ url('/') }}">
        <div class="row align-items-center">
            <img src="/img/ic_logo.webp" alt="logo" class="mr-2" height="72" width="72">
            <div class="col">
                <div class="row amaranth-regular" style="font-size: 24px; color: #6499E9;">
                    {{ config('app.school_name') }}</div>
                <div class="row urbanist-medium" style="font-size: 16px; color: black;">{{ config('app.app_category') }}
                </div>
            </div>
        </div>
    </a>
                ...
                @if (Route::has('register'))
                    <li class="nav-item">
                        <a class="btn btn-primary nav-link urbanist-semibold"
                            style="background-color: #6499E9; color: white; padding: 14px 22px;"
